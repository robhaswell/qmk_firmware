...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, KC_LBRC,                   KC_RBRC, KC_P1,   KC_P2,   KC_P3,   _______, KC_VOLU, \
  _______, _______, _______, _______, _______, KC_LCBR, _______, _______, KC_RCBR, KC_P0,   _______, _______, _______, KC_VOLD, \
