...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, KC_LCBR, _______, _______, KC_RCBR, KC_P0,   _______, _______, _______, _______, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,                   _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_VOLU, \
